...
export const projects = sqliteTable(
  "projects",
  {
    ...
    originMode: text("origin_mode").notNull().default("new"),
    historicalStartedAt: text("historical_started_at"),
    financialClassification: text("financial_classification").notNull().default("paid"),
